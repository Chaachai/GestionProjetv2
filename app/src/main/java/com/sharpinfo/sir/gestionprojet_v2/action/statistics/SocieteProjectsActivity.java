...
public class SocieteProjectsActivity extends AppCompatActivity {
    ...
    Societe societe = (Societe) Session.getAttribut("societeRecherce");

    private void initPieChartExpenses() {
        pieChartExpenses = findViewById(R.id.chartProjetSociete);
        ...
        for (Projet projet : projets) {
            total = total.add(depenseService.totalDepenseByProjet(projet));
        }
        ...
        pieChartExpenses.setCenterText("Depense Par Projet Pour " + societe.getRaisonSociale());
    ...
    private void initBarChart() {
        pieChartTime = findViewById(R.id.chart2ProjetSociete);
        ...
        Integer total = 0;
        for (Projet projet : projets) {
            total += tacheService.totalTacheByProjet(projet);
        }
        ...
        description.setEnabled(false);
        pieChartTime.setCenterText("Time Par Projet pour " + societe.getRaisonSociale());
    ...
    private void initChartSpinner() {
        spinner = findViewById(R.id.chart_choice_projetSociete);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_societe_projects);
        ...
        Button go = findViewById(R.id.chart_go_projetSociete);
