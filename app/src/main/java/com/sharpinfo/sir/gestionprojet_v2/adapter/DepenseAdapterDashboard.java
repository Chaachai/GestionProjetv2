...
public class DepenseAdapterDashboard extends RecyclerView.Adapter<DepenseAdapterDashboard.ViewHolder> {

    private List<Depense> mdepenses;
    DepenseListDashboardActivity depenseListDashboardActivity = new DepenseListDashboardActivity();


    public DepenseAdapterDashboard(List<Depense> depenses) {
        mdepenses = depenses;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            depenseitem = (ConstraintLayout) itemView.findViewById(R.id.depense_item_dashboard);
            seeMore = (TextView) itemView.findViewById(R.id.depense_seeMore_dashboard);
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        final View depenseView = inflater.inflate(R.layout.item_depense_list_dashboard, parent, false);
    ...
    @Override
    public void onBindViewHolder(DepenseAdapterDashboard.ViewHolder viewHolder, int position) {
