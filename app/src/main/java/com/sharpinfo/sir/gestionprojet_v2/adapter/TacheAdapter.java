...
//                                int minute = nbrOfMinutes % 60;
        ...
        viewHolder.tacheitem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TextView heurDebut = mView.findViewById(R.id.heur_debut_popup_tache);
                ...
                date.setText(dateString);
                heurDebut.setText(mtaches.get(viewHolder.getAdapterPosition()).getHeureDebut());
                heurFin.setText(mtaches.get(viewHolder.getAdapterPosition()).getHeureFin());
